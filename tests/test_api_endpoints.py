...
Note: Les tests utilisent la fixture app_with_overrides pour une gestion
simplifiée des overrides de dépendances sans chargement paresseux.
"""
...
class TestAPIEndpoints:
    ...
    def test_get_sessions(self, app_with_overrides, mock_db_service):
        """Test de récupération des sessions"""
        from src.api.services import get_database_service
        
        # Override de la dépendance (nettoyage automatique via fixture)
        app_with_overrides.dependency_overrides[get_database_service] = lambda: mock_db_service
    ...
    def test_get_sessions_with_date_filter(self, app_with_overrides, mock_db_service):
    ...
    def test_get_session_details(self, app_with_overrides, mock_db_service):
    ...
    def test_get_session_not_found(self, app_with_overrides, mock_db_service, sample_sessions):
    ...
    def test_get_sets(self, app_with_overrides, mock_db_service):
    ...
    def test_get_sets_with_filters(self, app_with_overrides, mock_db_service):
    ...
    def test_get_exercises(self, app_with_overrides, mock_db_service):
    ...
    def test_get_practiced_exercises(self, app_with_overrides, mock_db_service):
...
class TestAnalyticsEndpoints:
    ...
    def test_get_volume_analytics(self, app_with_overrides, mock_analytics_service):
        """Test des analytics de volume"""
        from src.api.services import get_analytics_service
        
        # Override de la dépendance (nettoyage automatique via fixture)
        app_with_overrides.dependency_overrides[get_analytics_service] = lambda: mock_analytics_service
    ...
    def test_get_one_rm_analytics(self, app_with_overrides, mock_analytics_service):
    ...
    def test_get_progression_analytics(self, app_with_overrides, mock_analytics_service):
    ...
    def test_get_exercise_analytics(self, app_with_overrides, mock_analytics_service, mock_db_service):
    ...
    def test_get_dashboard_analytics(self, app_with_overrides, mock_analytics_service):
        """Test du dashboard"""
        from src.api.services import get_analytics_service
    ...
    def test_analytics_with_date_filters(self, app_with_overrides, mock_analytics_service):
...
class TestStatusEndpoint:
    ...
    def test_get_status_healthy(self, app_with_overrides):
    ...
    def test_get_status_degraded(self, app_with_overrides):
